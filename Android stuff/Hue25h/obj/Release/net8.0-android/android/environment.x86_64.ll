...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33554539, ; uint32_t android_runtime_jnienv_class_token (0x200006b)
	i32 100663974, ; uint32_t jnienv_initialize_method_token (0x60002a6)
	i32 100663973, ; uint32_t jnienv_registerjninatives_method_token (0x60002a5)
...
@dso_cache = dso_local local_unnamed_addr global [84 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3662830945505405452, ; hash 0x32d4fd56a3286a0c, from name: aot-Hue25h
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9984845026882836174, ; hash 0x8a914ba664ad56ce, from name: aot-Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 11521526159618838479, ; hash 0x9fe4aeff9e738fcf, from name: libaot-Hue25h
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 50
	...
	%struct.DSOCacheEntry {
		i64 12496973154067026441, ; hash 0xad6e2adf2fc21209, from name: libaot-Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 58
	...
	%struct.DSOCacheEntry {
		i64 16458341677233973684, ; hash 0xe467c68e2f89a9b4, from name: Hue25h
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	...
	%struct.DSOCacheEntry {
		i64 17877591778633078134, ; hash 0xf819f700ccde5576, from name: Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0d551c05-5359-4ecb-a28d-49217985f4d6\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"com.c25h.USV25h\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-Hue25h.dll.so\00", align 16
