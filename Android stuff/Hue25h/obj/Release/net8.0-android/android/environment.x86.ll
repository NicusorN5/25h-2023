...
@dso_cache = dso_local local_unnamed_addr global [84 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 182426763, ; hash 0xadf9c8b, from name: libaot-Hue25h
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1456794342, ; hash 0x56d4eae6, from name: Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 17
	...
	%struct.DSOCacheEntry {
		i64 1950414351, ; hash 0x7440f60f, from name: libaot-Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	...
	%struct.DSOCacheEntry {
		i64 2642122765, ; hash 0x9d7b980d, from name: Hue25h
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 46
	...
	%struct.DSOCacheEntry {
		i64 3885397452, ; hash 0xe79675cc, from name: aot-Hue25h.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	%struct.DSOCacheEntry {
		i64 3895658726, ; hash 0xe83308e6, from name: aot-Hue25h
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Hue25h.dll.so
		ptr null; void* handle (0x0)
	}, ; 74
